...
import ru.aberezhnoy.server.core.handler.FilesInboundHandler;

public class ServerPipelineCheckoutService {

    public static void createPipelineForInboundFilesReceiving(ChannelHandlerContext ctx, String fileName, String userDirectory, String login, Long fileSize) {
